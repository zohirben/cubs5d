...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/12/04 21:56:09 by zbenaiss          #+#    #+#             */
/*   Updated: 2023/12/04 21:57:37 by zbenaiss         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int					rgb_f(char **strs, t_data *data, t_textures *t,
						t_var *vars);
int					rgb_c(char **strs, t_data *data, t_textures *t,
						t_var *vars);
void				ft_rgb(char *str, t_data *data);
void				ft_rgb_c(char *str, t_data *data);
char				*ft_textures(char *str, int i);
void				ft_draw_textures(t_data *data, float x_img, float y_start,
						float y_end);
void				check_map(char **strs);
...
void				apply_direction(t_data *data, char direction, int *x,
						int *y);
...
int					textures_checker(char **strs, t_var *v, t_textures *t,
						t_data *data);
int					check_textures(char **strs, t_textures *t, t_data *data);
void				check_textures_rgb(t_textures *t);
void				ft_mlx_begin(t_textures *t, t_data *data, t_window *win);
