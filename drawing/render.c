...
/*   Updated: 2023/11/29 22:44:13 by sbellafr         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	calculate_horizontal(t_data *data, float ray_angle)
{
	...
	{
		data->y_ray = (((int)data->player->y_map / TILE_SIZE)) * TILE_SIZE
			- 0.002;
		data->y_step = -TILE_SIZE;
	}
	data->x_ray = ((data->y_ray - (data->player->y_map)) / tan(ray_angle * (M_PI
					/ 180))) + data->player->x_map;
...
void	calculate_vertical(t_data *data, float ray_angle)
{
	...
	data->y_ray = ((data->x_ray - (data->player->x_map)) * tan(ray_angle * (M_PI
					/ 180))) + data->player->y_map;
